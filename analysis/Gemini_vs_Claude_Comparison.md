...
|--------|---------------|------------|--------------|
| Total Datasets Evaluated | 49 | 45 | 48 |
...
| finland_census | 0.0 | - | - |
| google_sustainability_financial_incentives | 0.0 | - | - |
| india_ndap | **6.7** | 0.0 | 0.0 |
| india_ndap_india_nss_health_ailments | **25.0** | 0.0 | 0.0 |
| india_nfhs | 0.0 | **0.1** | 0.0 |
| india_rbistatedomesticproduct | 0.0 | - | - |
| inpe_fire | 0.0 | - | **12.5** |
| ipeds | 0.0 | - | - |
| ireland_census | 0.0 | - | - |
| mexico_subnational_population_statistics_mexico_census_aa2 | 0.0 | - | - |
| ncses_median_annual_salary | **8.1** | 8.1 | 8.1 |
| ncses_ncses_demographics_seh_import | 7.3 | 10.5 | **18.4** |
| ncses_research_doctorate_recipients | 0.0 | - | - |
| ntia_internet_use_survey | 0.0 | - | - |
| nyu_diabetes_texas | 0.0 | - | - |
...
| opendataforafrica_rwanda_census | 0.0 | - | - |
| school_algebra1 | 0.0 | - | - |
| school_finance | 0.0 | - | - |
| school_retention | 0.0 | - | - |
| southkorea_statistics_education | 0.0 | - | 0.0 |
| southkorea_statistics_employment | 0.0 | 0.0 | 0.0 |
| southkorea_statistics_health | 0.0 | **2.9** | 2.9 |
| statistics_new_zealand_new_zealand_census | 0.0 | - | - |
| uae_bayanat | 0.0 | - | - |
| undata | 88.8 | **89.9** | 89.9 |
| us_bachelors_degree_data | 0.0 | - | - |
...
| us_federal_reserve_h15_interest_rates | 0.0 | - | - |
| us_steam_degrees_data | **11.5** | 11.5 | 11.5 |
| us_urban_school_teachers | 0.0 | - | 0.0 |
| usa_dol | 0.0 | - | - |
...
| school_finance | 0.0 | - | - |
| school_retention | 0.0 | - | - |
| southkorea_statistics_education | 0.0 | - | **188.5** |
...
| us_urban_school_teachers | 31.4 | - | **40.0** |
| usa_dol | 0.0 | - | - |
...
| us_urban_school_teachers | 2.1 | - | **8.2** |
| usa_dol | 0.0 | - | - |
...
- `-` indicates dataset not evaluated for that model
