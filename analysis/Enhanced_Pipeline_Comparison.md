...
**Generated**: 2026-04-03T12:21:11.393728+00:00
...
|--------|--------|--------|--------|--------|
| Total Datasets Evaluated | 49 | 49 | 49 | 59 |
| Average Node Accuracy | 4.6% | 11.5% | 11.7% | 30.7% |
| Average Node Coverage | 45.8% | 60.1% | 60.1% | 59.2% |
| Average PV Accuracy | 8.1% | 19.2% | 20.5% | 24.3% |
...
|---------|---------------|--------------|----------------|---------------------|----------|
| bis_bis_central_bank_policy_rate | 0.0 | 14.3 | 14.3 | **214.3** | 303.5 |
...
| finland_census | 0.0 | 0.0 | 0.0 | 0.0 | 623.4 |
...
| ipeds | 0.0 | 0.0 | 0.0 | **400.0** | 552.5 |
| ireland_census | 0.0 | 0.0 | 0.0 | **100.0** | 355.4 |
| mexico_subnational_population_statistics_mexico_census_aa2 | 0.0 | 0.0 | 0.0 | **1.6** | 370.1 |
| ncses_median_annual_salary | **8.1** | **8.1** | **8.1** | **8.1** | 197.6 |
| ncses_ncses_demographics_seh_import | 7.3 | 10.5 | **18.4** | 2.6 | 362.6 |
| ncses_research_doctorate_recipients | 0.0 | 0.0 | 0.0 | — | — |
| ntia_internet_use_survey | 0.0 | 0.0 | 0.0 | — | — |
| nyu_diabetes_texas | 0.0 | 0.0 | 0.0 | **0.7** | 369.3 |
...
| school_algebra1 | 0.0 | 0.0 | 0.0 | 0.0 | 674.9 |
...
| statistics_new_zealand_new_zealand_census | 0.0 | 0.0 | 0.0 | **6.9** | 293.2 |
...
| us_crash_fars_crashdata | 5.9 | 4.4 | 3.7 | **32.4** | 513.4 |
| us_federal_reserve_h15_interest_rates | 0.0 | 0.0 | 0.0 | 0.0 | 222.4 |
| us_steam_degrees_data | **11.5** | **11.5** | **11.5** | **11.5** | 256.0 |
| us_urban_school_teachers | 0.0 | 0.0 | 0.0 | **20.0** | 386.8 |
| usa_dol | 0.0 | 0.0 | 0.0 | 0.0 | 309.8 |
...
| Dataset | Gemini Base % | Claude CLI % | Gemini 3 Pro % | Enhanced Pipeline % | Time (s) |
|---------|---------------|--------------|----------------|---------------------|----------|
| bis_bis_central_bank_policy_rate | 100.0 | 100.0 | 114.3 | **242.9** | 303.5 |
...
| ipeds | 0.0 | 0.0 | 0.0 | **500.0** | 552.5 |
| ireland_census | 0.0 | 0.0 | 0.0 | **128.6** | 355.4 |
| mexico_subnational_population_statistics_mexico_census_aa2 | 0.0 | 0.0 | 0.0 | **92.2** | 370.1 |
| ncses_median_annual_salary | 10.8 | **13.5** | **13.5** | 10.8 | 197.6 |
| ncses_ncses_demographics_seh_import | 9.8 | **76.3** | 63.2 | 5.3 | 362.6 |
| ncses_research_doctorate_recipients | 0.0 | 0.0 | 0.0 | — | — |
| ntia_internet_use_survey | 0.0 | 0.0 | 0.0 | — | — |
| nyu_diabetes_texas | 0.0 | 0.0 | 0.0 | **5.5** | 369.3 |
...
| us_crash_fars_crashdata | 11.8 | 11.8 | 6.6 | **43.4** | 513.4 |
| us_federal_reserve_h15_interest_rates | 0.0 | 0.0 | 0.0 | **40.0** | 222.4 |
| us_steam_degrees_data | 13.5 | **17.3** | **17.3** | 13.5 | 256.0 |
| us_urban_school_teachers | 31.4 | 0.0 | 40.0 | **51.4** | 386.8 |
| usa_dol | 0.0 | 0.0 | 0.0 | **90.5** | 309.8 |
...
| Dataset | Gemini Base % | Claude CLI % | Gemini 3 Pro % | Enhanced Pipeline % | Time (s) |
|---------|---------------|--------------|----------------|---------------------|----------|
| bis_bis_central_bank_policy_rate | 0.0 | 18.2 | 36.4 | **60.0** | 303.5 |
...
| ccd_enrollment | 23.2 | **31.9** | 0.0 | 0.9 | 793.8 |
| cdc_social_vulnerability_index | 4.9 | **28.3** | 14.6 | 20.5 | 562.3 |
| census_v2_sahie | 8.0 | **34.8** | 34.1 | 30.4 | 507.2 |
| census_v2_saipe | 35.7 | 50.0 | 53.3 | **58.8** | 302.9 |
| child_birth | 0.0 | 0.0 | 0.0 | 0.0 | 336.2 |
| commerce_eda | 0.0 | 0.0 | 6.7 | **26.2** | 490.4 |
| crdc_import_crdc_harassment_or_bullying | 0.0 | 0.0 | 0.0 | 0.0 | 507.9 |
| crdc_instructional_wifi_devices | 0.0 | 0.0 | 0.0 | **38.9** | 448.4 |
...
| ipeds | 0.0 | 0.0 | 0.0 | **81.8** | 552.5 |
| ireland_census | 0.0 | 0.0 | 0.0 | **47.1** | 355.4 |
| mexico_subnational_population_statistics_mexico_census_aa2 | 0.0 | 0.0 | 0.0 | **91.5** | 370.1 |
| ncses_median_annual_salary | **5.4** | **5.4** | **5.4** | **5.4** | 197.6 |
| ncses_ncses_demographics_seh_import | 3.9 | 6.2 | **8.1** | 0.7 | 362.6 |
| ncses_research_doctorate_recipients | 0.0 | 0.0 | 0.0 | — | — |
| ntia_internet_use_survey | 0.0 | 0.0 | 0.0 | — | — |
| nyu_diabetes_texas | 0.0 | 0.0 | 0.0 | **8.8** | 369.3 |
...
| statistics_new_zealand_new_zealand_census | 0.0 | 0.0 | 0.0 | **2.3** | 293.2 |
| uae_bayanat | 0.0 | 0.0 | 0.0 | — | — |
...
| us_crash_fars_crashdata | 2.1 | 1.0 | 1.2 | **5.9** | 513.4 |
| us_federal_reserve_h15_interest_rates | 0.0 | 0.0 | 0.0 | **5.0** | 222.4 |
| us_steam_degrees_data | **7.1** | **7.1** | **7.1** | **7.1** | 256.0 |
| us_urban_school_teachers | 2.1 | 0.0 | **8.2** | 6.5 | 386.8 |
| usa_dol | 0.0 | 0.0 | 0.0 | **86.6** | 309.8 |
