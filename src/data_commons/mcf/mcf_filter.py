...
try:
    from src.data_commons.mcf.mcf_file_util import load_mcf_nodes, write_mcf_nodes
    from src.data_commons.mcf.mcf_file_util import add_namespace, strip_namespace
    from src.data_commons.mcf.mcf_file_util import check_nodes_can_merge
except ImportError:
...
try:
    from src.data_commons.mcf.mcf_diff import diff_mcf_node_pvs, get_diff_config
except ImportError:
