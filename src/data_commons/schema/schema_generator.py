...
try:
    from src.data_commons.api.dc_api_wrapper import dc_api_get_node_property_values
except ImportError:
    from dc_api_wrapper import dc_api_get_node_property_values

try:
    from src.data_commons.mcf.mcf_file_util import load_mcf_nodes, write_mcf_nodes, normalize_value
    from src.data_commons.mcf.mcf_file_util import add_namespace, strip_namespace, add_mcf_node
    from src.data_commons.mcf.mcf_file_util import get_value_list
except ImportError:
