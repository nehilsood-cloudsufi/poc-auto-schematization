...
try:
    ...
    from src.data_commons.mcf.mcf_file_util import add_namespace, strip_namespace, normalize_mcf_node
except ImportError:
...
try:
    from src.data_commons.mcf.mcf_diff import fingerprint_node
except ImportError:
